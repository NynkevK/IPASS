...
public class BaseDAO {
	...
	// Dit is de methodde die contact maakt met de database
	public BaseDAO() {
		try {
	...
	// Deze methode geeft een connectie, welke door alle andere DAO's kan worden gebruikt om redundantie in de code te voorkokmen
